...
function playGame(num){
  ...
  var starterIndex, subsIndex;

  for (var i=0; i<starters.length; i++){
    startOff += starters[i].offense;
    startDef += starters[i].defense;
  }
  ...
  console.log("Change your starters!");
  for (var i=0; i<starters.length; i++){
    console.log(i +": "starters)
  }

  inquirer.prompt([
      {
        starter : "starter",
        message : "Player number to remove"
      }
  ]).then(function(answers) {

    starterIndex = answers.starter;
